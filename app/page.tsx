...
export default function SignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Successful signup - trigger animated sign-in credentials
      ...
      if (signInResult?.error) {
        // Fallback directly to login if autologin has issues
        router.push("/login");
      } else {
        // Trigger the spectacular animated loading splash page
        setShowLoader(true);
      }
    } catch {
        ...
        <div className="my-auto max-w-[400px] w-full mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-1">
            ...
            >
              {loading ? (
                <>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" className="animate-spin text-white">
