...
- Name: auth\chef-login.spec.ts >> 3.4 valid phone number enables Send OTP button
- Location: tests\auth\chef-login.spec.ts:71:5
...
Locator: locator('button').filter({ hasText: /send otp|send/i }).first()
Expected: not disabled
Timeout: 3000ms
Error: element(s) not found

Call log:
  - Expect "not toBeDisabled" with timeout 3000ms
...
- text: "+91"
- textbox "98765 43210": "9876543210"
- button "Continue →"
- link "Admin login →":
  - /url: /login
- alert
