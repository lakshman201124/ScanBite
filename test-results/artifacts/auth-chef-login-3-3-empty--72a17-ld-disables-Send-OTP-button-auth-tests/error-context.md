...
- Name: auth\chef-login.spec.ts >> 3.3 empty phone field disables Send OTP button
- Location: tests\auth\chef-login.spec.ts:60:5

# Error details

```
TimeoutError: locator.isDisabled: Timeout 15000ms exceeded.
Call log:
...
- generic [ref=e1]:
  - generic [ref=e5]:
    ...
    - generic [ref=e15]:
      ...
      - generic [ref=e18]:
        - generic [ref=e19]: "+91"
        - textbox "98765 43210" [active] [ref=e20]
